    ...
    <div class="nk-sidebar">
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li>
                    <a href="{{ route('admin.consignee.list') }}" aria-expanded="false">
                        <i class="fa fa-user"></i><span class="nav-text">Party</span>
                    </a>
                </li>

                <li>
                    <a href="{{ route('admin.transporter.list') }}" aria-expanded="false">
                        <i class="fa fa-truck"></i><span class="nav-text">Transporter</span>
                    </a>
                </li>
