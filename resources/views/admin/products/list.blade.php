            ...
            <div class="modal-content">
                <form class="form-valide" action="" id="ProductForm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            <label class="col-form-label" for="hsn_code">HSN Code <span class="text-danger">*</span></label>
                            <input type="text" class="form-control input-flat" id="hsn_code" name="hsn_code" placeholder="">
                            <div id="hsn_code-error" class="invalid-feedback animated fadeInDown" style="display: none;"></div>
                        </div>
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control input-flat" id="description" name="description" placeholder="" rows="5"></textarea>
        ...
        $.ajax({
            ...
            success: function (res) {
                if(res.status == 'failed'){
                    ...
                    if (res.errors.hsn_code) {
                        $('#hsn_code-error').show().text(res.errors.hsn_code);
                    } else {
                        $('#hsn_code-error').hide();
                    }
                ...
                if(res.status == 200){
                    if(btn_type == 'save_close'){
                        ...
                        if(res.action == 'add'){
                            Product_Table(true);
                            toastr.success("Product has been Added Successfully",'Success',{timeOut: 5000});
                        }
                        if(res.action == 'update'){
                            Product_Table();
                            toastr.success("Product has been Updated Successfully",'Success',{timeOut: 5000});
                        }
                    }
