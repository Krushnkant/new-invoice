...
Route::group(['prefix'=>'admin','middleware'=>['auth'],'as'=>'admin.'],function () {
    ...
    Route::get('transporter',[\App\Http\Controllers\admin\TransporterController::class,'index'])->name('transporter.list');
    Route::post('addorupdatetransporter',[\App\Http\Controllers\admin\TransporterController::class,'addorupdatetransporter'])->name('transporter.addorupdate');
    Route::post('alltransporterlist',[\App\Http\Controllers\admin\TransporterController::class,'alltransporterlist'])->name('alltransporterlist');
    Route::get('transporter/{id}/edit',[\App\Http\Controllers\admin\TransporterController::class,'edittransporter'])->name('transporter.edit');
    Route::get('transporter/{id}/delete',[\App\Http\Controllers\admin\TransporterController::class,'deletetransporter'])->name('transporter.delete');
    
    Route::get('consignee',[\App\Http\Controllers\admin\ConsigneeController::class,'index'])->name('consignee.list');
    Route::post('addorupdateparty',[\App\Http\Controllers\admin\ConsigneeController::class,'addorupdateparty'])->name('consignee.addorupdate');
    Route::post('allpartylist',[\App\Http\Controllers\admin\ConsigneeController::class,'allpartylist'])->name('allpartylist');
    Route::get('consignee/{id}/edit',[\App\Http\Controllers\admin\ConsigneeController::class,'editparty'])->name('consignee.edit');
    Route::get('consignee/{id}/delete',[\App\Http\Controllers\admin\ConsigneeController::class,'deleteparty'])->name('consignee.delete');
...
//    Route::get('changeuserstatus/{id}',[\App\Http\Controllers\admin\UserController::class,'changeuserstatus'])->name('users.changeuserstatus');
    ...
    Route::post('invoice/change_inv_consignee',[\App\Http\Controllers\admin\InvoiceController::class,'change_inv_consignee'])->name('invoice.change_inv_consignee');
